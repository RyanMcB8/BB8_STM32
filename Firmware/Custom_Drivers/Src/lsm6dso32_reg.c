...
/**
  ...
  *
  */
float_t lsm6dso32_from_fs4_to_ms2(int16_t lsb)
{
  return ((float_t)lsb) * 0.00119682f;               //0.122 x 1/1000 x 9.81
}

float_t lsm6dso32_from_fs8_to_ms2(int16_t lsb)
{
  return ((float_t)lsb) * 0.00239264f;               //0.244 x 1/1000 x 9.81
}

float_t lsm6dso32_from_fs16_to_ms2(int16_t lsb)
{
  return ((float_t)lsb) * 0.00478728f;               //0.488 x 1/1000 x 9.81
}

float_t lsm6dso32_from_fs32_to_ms2(int16_t lsb)
{
  return ((float_t)lsb) * 0.00957456f;               //0.976 x 1/1000 x 9.81
}
...
//RADIANS PER SECOND
float_t lsm6dso32_from_fs125_to_rads(int16_t lsb)
{
  return ((float_t)lsb) * 0.000076358f;
}

float_t lsm6dso32_from_fs250_to_rads(int16_t lsb)
{
  return ((float_t)lsb) * 0.000152716f;
}

float_t lsm6dso32_from_fs500_to_rads(int16_t lsb)
{
  return ((float_t)lsb) * 0.000305432f;
}

float_t lsm6dso32_from_fs1000_to_rads(int16_t lsb)
{
  return ((float_t)lsb) * 0.000610865f;
}

float_t lsm6dso32_from_fs2000_to_rads(int16_t lsb)
{
  return ((float_t)lsb) * 0.001221730f;
}
