...
#ifndef DELTA_T
    #define DELTA_T 0.0048f // 208Hz sampling frequency
#endif
...
{
    return sqrt((double) q.q1*(double) q.q1 + (double) q.q2*(double) q.q2 +
                (double) q.q3*(double) q.q3 + (double) q.q4*(double) q.q4);
}
...
static inline void printQuaternion (struct quaternion q){
    printf("%f %f %f %f\n", (double) q.q1, (double) q.q2, (double) q.q3, (double) q.q4);
}
