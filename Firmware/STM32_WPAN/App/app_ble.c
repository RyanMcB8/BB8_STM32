...
#define ADV_TYPE                    0x00  /* Connectable undirected advertising */
#define ADV_FILTER                  0x00  /* No filter, all devices can scan/connect */
#if (P2P_SERVER1 != 0)
static const char a_LocalName[] = {AD_TYPE_COMPLETE_LOCAL_NAME ,'B','B','8','m','a','i','n'};
