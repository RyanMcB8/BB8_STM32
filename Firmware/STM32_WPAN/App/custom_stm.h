...
{
  /* D11A */
  CUSTOM_STM_D11A_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_D11A_NOTIFY_DISABLED_EVT,
  /* C44D */
  CUSTOM_STM_C44D_WRITE_EVT,
  /* D11C */
  CUSTOM_STM_D11C_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_D11C_NOTIFY_DISABLED_EVT,
  /* C44F */
  CUSTOM_STM_C44F_WRITE_EVT,
...
/* Exported constants --------------------------------------------------------*/
extern uint16_t SizeD11A;
extern uint16_t SizeC44D;
extern uint16_t SizeD11C;
extern uint16_t SizeC44F;
