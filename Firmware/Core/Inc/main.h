...
#define DIR_HEAD_MOTOR_Pin GPIO_PIN_6
#define DIR_HEAD_MOTOR_GPIO_Port GPIOC
#define RIGHT_SERVO_Pin GPIO_PIN_10
#define RIGHT_SERVO_GPIO_Port GPIOA
#define STEP_LEFT_MOTOR_Pin GPIO_PIN_15
...
#define STEP_HEAD_MOTOR_Pin GPIO_PIN_6
#define STEP_HEAD_MOTOR_GPIO_Port GPIOB
